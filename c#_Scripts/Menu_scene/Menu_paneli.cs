...
public class Menu_paneli : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip sat�nAlma_sesi;
    ...
    public void karekter1_evet_btn()
    {
        if (toplamAltin >= 5000)
        {
            ...
            audioSource.PlayOneShot(sat�nAlma_sesi);

            karekter1_Kullanbtn_Aktiflik();

            satinalmamesaj1.text = "Arissa Karekteri Sat�n Al�nd� .";
            Debug.Log("*** Karekter1 satin alindi ***");
        }
        else
        {
            satinalmamesaj1.text = "karekter sat�n alma ba�ar�s�z ! alt�n�n�z yetersiz!";
            Debug.Log(" karekter sat�n alma ba�ar�s�z ! alt�n�n�z yetersiz!");
        }
        // karekter2_buy = false;
    }
    public void karekter2_evet_btn()
    {
        if (toplamElmas >= 200)
        {
            ...
            satinalmamesaj2.text = "Mutant Karekteri Sat�n Al�nd� .";
            Debug.Log("*** Karekter2 satin alindi ***");
        }
        else
        {
            satinalmamesaj2.text = "karekter sat�n alma ba�ar�s�z ! alt�n�n�z yetersiz!";
            Debug.Log(" karekter sat�n alma ba�ar�s�z ! alt�n�n�z yetersiz!");
        }
    }
    ...
    public void karekter3_evet_btn()
    {
        if (toplamAltin >= 7000)
        {
            ...
            satinalmamesaj3.text = "Zombie Karekteri Sat�n Al�nd� .";
            Debug.Log("*** Karekter3 satin alindi ***");
        }
        else
        {
            satinalmamesaj3.text = "karekter sat�n alma ba�ar�s�z ! alt�n�n�z yetersiz!";
            Debug.Log(" karekter sat�n alma ba�ar�s�z ! alt�n�n�z yetersiz!");
        }
    }
